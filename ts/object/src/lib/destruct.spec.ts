...
// export function destruct( item:any, params?:any ) {

//     if ( item instanceof Object ) { return destructObject( item ) }

//     else if ( item instanceof Array ) { return destructArray(item) }
...
// function destructObject( item:Object, params?:any ) {
//     let r:any = {}
...
// function destructArray(  items:Array<any>, params?:any ) {
